<template>
  <div class="flex flex-col flex-1 items-center">
    <!-- Banner -->
    <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-clip">
      <p>
    ...
    <div class="mx-w-screen-md w-full py-12">
      <div class="mx-8 text-white">
        ...
        <div class="flex gap-10 overflow-x-scroll">
          <div 
          v-for="hourData in weatherData.hourly" :key="hourData"
    ...
    duraton-150 hover:text-red-500">
